...
from ..pipelines.pipeline_mvadapter_t2mv_sd import MVAdapterT2MVSDPipeline
...
class MVAdapterTextSDSystem(BaseSystem):
    @dataclass
    ...
    def configure(self):
        ...
        pipeline: MVAdapterT2MVSDPipeline
        pipeline = MVAdapterT2MVSDPipeline.from_pretrained(
        ...
        # Prepare models
        self.pipeline: MVAdapterT2MVSDPipeline = pipeline
