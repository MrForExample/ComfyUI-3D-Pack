# This script is modified based on: https://github.com/NVIDIAGameWorks/kaolin/blob/5406915c3a020596384b1a36679ff68afd04d455/examples/tutorial/dmtet_network.py
...
class Decoder(torch.nn.Module):
    ...
    def get_sdf_and_deform(self, out):
        return out[:,0], out[:,1:]  # sdf, deform

    def pre_train_sphere(self, iter=1000):
