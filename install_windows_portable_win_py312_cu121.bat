...
set "requirements_post_txt=%~dp0\requirements_post_win_py312_cu121.txt"
set "python_exec=..\..\..\python_embeded\python.exe"

set "python_target_include=..\..\..\python_embeded\include"
set "python_target_libs=..\..\..\python_embeded\libs"
set "python_include=%~dp0\_Pre_Builds\_Python312_cpp\include"
set "python_libs=%~dp0\_Pre_Builds\_Python312_cpp\libs"
